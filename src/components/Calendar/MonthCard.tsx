...
export default function MonthCard({
  ...
  return (
    <div
      className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-200 cursor-pointer flex flex-col h-full"
      onClick={onClick}
    >
      {/* Month Image */}
      <div className="relative h-48 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center overflow-hidden flex-shrink-0">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* AI Campaign Button - always at bottom with consistent spacing */}
        <div className="pt-4">
          <button
            type="button"
            onClick={(e) => {
